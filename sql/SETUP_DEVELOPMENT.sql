-- ============================================================
-- UTILITÁRIOS MUNICIPAIS — BANCO DE DESENVOLVIMENTO
-- Base: schema consolidado da versão 4.3.6
-- Execute SOMENTE no projeto Supabase de DESENVOLVIMENTO.
--
-- Este script cria estrutura, índices, triggers, privilégios e RLS.
-- Ele NÃO copia dados nem usuários do projeto de produção.
-- ============================================================

...
const TOOL_REGISTRY = Object.freeze([
    ...
    { id: "fluxos", name: "Fluxos de trabalho", shortName: "Fluxos", icon: "workflow", category: "Produtividade", order: 60, description: "Organize dados de um atendimento e encaminhe-os entre os módulos do sistema.", keywords: ["fluxo", "processo", "atendimento", "documento", "etapas", "integração", "contexto"], module: "fluxos" },
...
const TOOL_ICON_PATHS = Object.freeze({
    ...
    workflow: '<circle cx="5" cy="6" r="2"/><circle cx="19" cy="6" r="2"/><circle cx="12" cy="18" r="2"/><path d="M7 6h10M6.5 7.5l4.3 8.2M17.5 7.5l-4.3 8.2"/>',

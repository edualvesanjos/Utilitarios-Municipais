...
A pesquisa global e os atalhos de aparência ficam integrados à sidebar. No desktop, a barra pode ser recolhida; em telas menores, funciona como menu deslizante. O acesso à conta fica na base, por um ícone de perfil com indicação visual do estado de sincronização.
